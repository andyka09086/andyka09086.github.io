<div class="modal fade" id="tolak<?php echo $row->name_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	<div class="modal-dialog">
        ...
        <a href="<?php echo site_url('message/TolakData/'.$row->name_id); ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;Yes</a>
