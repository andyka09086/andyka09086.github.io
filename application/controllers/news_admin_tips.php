...
class news_admin_tips extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_NewsAdminTips', 'data');
    ...
    $data['content']='admin/VIEW_NewsAdminTips';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditNewsAdminTips',$data);
	}
