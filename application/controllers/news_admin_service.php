...
class news_admin_service extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_NewsAdminService', 'data');
    ...
    $data['content']='admin/VIEW_NewsAdminService';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditNewsAdminService',$data);
	}
