...
class about_konten1 extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_AboutKonten1', 'data');
    ...
    $data['content']='admin/VIEW_AboutKonten1';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditAboutKonten1',$data);
	}
