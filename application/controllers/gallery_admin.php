...
class gallery_admin extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_GalleryAdmin', 'data');
    ...
    $data['content']='admin/VIEW_GalleryAdmin';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditGalleryAdmin',$data);
	}
