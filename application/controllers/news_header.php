...
class news_header extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_NewsHeader', 'data');
    ...
    $data['content']='admin/VIEW_NewsHeader';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditNewsHeader',$data);
	}
