...
class about_konten2 extends CI_Controller {
	function __construct(){
		parent::__construct();
		$this->load->helper('url','form');
		$this->load->model('admin/MODEL_AboutKonten2', 'data');
    ...
    $data['content']='admin/VIEW_AboutKonten2';
	...
	public function GetData()
	{
		...
		$this->load->view('admin/VIEW_EditAboutKonten2',$data);
	}
